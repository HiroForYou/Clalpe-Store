...
const AboutScreen = () => {
  return (
    <>
      ...
      <p className="about-p">
        Clalpe opened in 1980 and built by offering great prices on fine vintage
        jewelry, mint-condition pre-owned watches, loose diamonds, and
        engagement rings, because that was what my customers wanted. As time
      ...
      <p>
        ...
        just joined us on the trip into a bright future with Clalpe.
      </p>
      <p>-- John Doe</p>
    </>
  );
